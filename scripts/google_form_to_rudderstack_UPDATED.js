 ...
 *    - Optional: "Product" or "Program" (dropdown/list) - e.g. Liver, Cholesterol, Bundle. Sent as productName
...
function onFormSubmit(e) {
  try {
    ...
    if (!patientEmail || !kimsNote) {
      Logger.log("Missing required fields: email or note");
      return;
    }
